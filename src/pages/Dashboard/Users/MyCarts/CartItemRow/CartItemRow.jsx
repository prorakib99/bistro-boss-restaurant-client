    ...
    return (
        <tr className='flex items-center justify-between md:justify-around lg:px-10 py-3 border-b sm:py-5'>
            <td className='flex items-center gap-4 md:gap-10'>
                <span className="text-neutral-900 text-xl font-bold font-['Inter']">
                    {index + 1}
                </span>
            </td>
            <td className='flex items-center gap-4 md:gap-10'>
            ...
            <td className="text-neutral-500 text-base font-normal font-['Inter']">{name}</td>
            <td className="text-neutral-500 text-base font-normal font-['Inter']">${price}</td>
            <td className=''>
