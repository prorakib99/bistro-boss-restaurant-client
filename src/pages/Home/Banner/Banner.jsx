...
const Banner = () => {
    return (
        <div className=''>
            ...
            >
                <div>
                    <img className='xl:h-[90vh]' src={bannerImg1} />
                </div>
                <div>
                    <img className='xl:h-[90vh]' src={bannerImg2} />
                </div>
                <div>
                    <img className='xl:h-[90vh]' src={bannerImg3} />
                </div>
                <div>
                    <img className='xl:h-[90vh]' src={bannerImg4} />
                </div>
                <div>
                    <img className='xl:h-[90vh]' src={bannerImg5} />
                </div>
                <div>
                    <img className='xl:h-[90vh]' src={bannerImg6} />
                </div>
            </Carousel>
        </div>
    );
