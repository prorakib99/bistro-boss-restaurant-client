    ...
    return (
        <>
            ...
            <div
                ...
                className='bg-no-repeat bg-cover min-h-full lg:h-screen overflow-x-hidden lg:w-screen flex justify-center px-5 items-center'
            >
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className='grid gap-4'>
                            ...
                            <div className='flex gap-2 relative flex-col'>
                                ...
                                {errors.password?.type === 'pattern' && (
                                    <span className='text-red-500'>
                                        Please Enter at least enter one (Uppercase, Lowercase,
                                        Number and Special)
                                    </span>
                                )}
                            </div>
