                            ...
                            <div className='grid lg:grid-cols-2 mt-2 gap-5'>
                                <div className=''>
                                    ...
                                    <button
                                        ...
                                        className="text-indigo-500 disabled:hidden cursor-pointer text-start ps-2 text-lg hover:text-indigo-700 font-semibold font-['Inter']"
                                    >
                                        Reload Captcha
                                    </button>
                                </div>
                                <div className='relative'>
                                    ...
                                    <button
                                        ...
                                        disabled={captchaStatus}
                                        className='btn btn-outline disabled:hidden mt-2 mr-2 absolute right-0  btn-sm font-bold'
                                    >
                                        Check
                                    </button>
                                </div>
